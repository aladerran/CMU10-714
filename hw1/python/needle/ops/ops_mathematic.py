...
class Transpose(TensorOp):
    ...
    def compute(self, a):
        ### BEGIN YOUR SOLUTION
        num_axes = len(array_api.shape(a))
        ...
        return array_api.transpose(a, axes=axes_order)
        ### END YOUR SOLUTION
...
class Reshape(TensorOp):
    ...
    def gradient(self, out_grad, node):
        ### BEGIN YOUR SOLUTION
        return reshape(out_grad, array_api.shape(node.inputs[0]))
        ### END YOUR SOLUTION
...
class BroadcastTo(TensorOp):
    ...
    def gradient(self, out_grad, node):
        ...
        for i, (input_dim, output_dim) in enumerate(zip(reversed(input_shape), reversed(self.shape))):
...
class Summation(TensorOp):
    ...
    def gradient(self, out_grad, node):
        ...
        if self.axes is None:
            ...
            axes = self.axes
        expand_shape = list(out_grad.shape)
        for ax in sorted(axes):
            expand_shape.insert(ax, 1)
        return broadcast_to(out_grad.reshape(expand_shape), input_shape)
        ### END YOUR SOLUTION
...
class MatMul(TensorOp):
    ...
    def gradient(self, out_grad, node):
        ...
        num_dim_a = len(array_api.shape(a))
        num_dim_b = len(array_api.shape(b))
